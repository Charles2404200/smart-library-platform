      ...
      {open && (
        <div className="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-white border border-gray-200 shadow-lg">
          <div className="py-1">
            ...
            {/* ✅ View Books now opens your MyLibrary page */}
            <Link to="/my-library" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
              View Books
            </Link>

            <Link to="/borrowed" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
              Books Borrowed
            </Link>
